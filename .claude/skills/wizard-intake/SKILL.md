---
name: wizard-intake
description: Gather FastEdge template params from the Gcore API and write wizards/<name>/TARGET.md + mock-ready fixture templates. Args: [wizard-name] [template-id-or-name ...]
---
...
- First arg: wizard name (kebab-case directory under `wizards/`)
