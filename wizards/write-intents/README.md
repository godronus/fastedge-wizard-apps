...
```bash
pnpm install
pnpm run dev   # builds and serves on http://localhost:8086
```

Point the portal's dev override at `http://localhost:8086/index.html?hostOrigin=https://portal.preprod.world`.
