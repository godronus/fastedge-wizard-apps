...
It's the reference example for multi-app deploy, CDN origin+rule wiring, shared secrets, Edge Storage binding, keypair generation, and Profile A/B branching.
